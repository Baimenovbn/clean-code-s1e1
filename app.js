...
var createNewTaskElement=function(taskString){
    ...
    //label
    var p=document.createElement("p");//label
    //input (text)
...
var editTask=function(){
    ...
    var editBtn=listItem.querySelector(".tasks__btn.tasks__btn_edit");
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.querySelector('.task__title').classList.add('task__title_completed')
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.querySelector('.task__title_completed').classList.remove('task__title_completed')
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector(".tasks__btn.tasks__btn_edit");
    var deleteButton=taskListItem.querySelector(".tasks__btn.tasks__btn_delete");
